    ...
    <div class="container-fluid newsletter">
        <div class="row">
            <!-- Newsletter Texte  -->
            <div class="col-7 newsletter-text_box">
                <h1 class="text-footer">Inscrivez-vous à notre<br>Newsletter</h1>
                <h6 class="text-footer">Les dernières nouvelles, articles et ressources envoyés<br>directement dans votre boîte de réception chaque semaine.</h6>
            </div>
            <!-- S'incrire au newsletter -->
            <div class="col newsletter-mail">
                <form class="form-news" id="form-news" action="">
                    <input class="form-news-style" id="subscribre" name="subscribre" placeholder="E-mail">
                    <input class="submit-news" type="submit" form="form-news" value=""/>
                </form>
            </div>
        </div>
    </div>
